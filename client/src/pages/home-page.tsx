      ...
      <div className="container mx-auto px-6 py-12">
        <div className="relative">
          ...
          >
            ...
            <h1 className="text-6xl font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-500 via-pink-500 to-purple-400 hover:bg-gradient-to-br transition-all duration-500 animate-text-shimmer">
